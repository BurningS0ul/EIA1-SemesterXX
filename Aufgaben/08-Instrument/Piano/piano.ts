...
function playSample(){     
    ...
    function Key1(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/c.mp3');
        sound.play();
        sound.volume = 0.2;        
    }
    document.querySelector(".black-1").addEventListener('click', Black1);
    function Black1(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/df.mp3');
        sound.play();
        sound.volume = 0.2;
    }
    document.querySelector(".key-2").addEventListener('click', Key2);
    function Key2(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/d.mp3');
        sound.play();
        sound.volume = 0.2;
    } 
    document.querySelector(".black-2").addEventListener('click', Black2);
    function Black2(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/ef.mp3');
        sound.play();
        sound.volume = 0.2;
    }
    document.querySelector(".key-3").addEventListener('click', Key3);
    function Key3(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/e.mp3');
        sound.play();
        sound.volume = 0.2;
    }          
    document.querySelector(".key-4").addEventListener('click', Key4);
    function Key4(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/f.mp3');
        sound.play();
        sound.volume = 0.2;
    }    
    document.querySelector(".black-3").addEventListener('click', Black3);
    function Black3(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/gf.mp3');
        sound.play();
        sound.volume = 0.2;
    }       
    document.querySelector(".key-5").addEventListener('click', Key5);
    function Key5(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/g.mp3');
        sound.play();
        sound.volume = 0.2;
    }
    document.querySelector(".black-4").addEventListener('click', Black4);
    function Black4(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/af.mp3');
        sound.play();
        sound.volume = 0.2;
    }   
    document.querySelector(".key-6").addEventListener('click', Key6);
    function Key6(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/a.mp3');
        sound.play();
        sound.volume = 0.2;
    }  
    document.querySelector(".black-5").addEventListener('click', Black5);
    function Black5(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/bf.mp3');
        sound.play();
        sound.volume = 0.2;
    }  
    document.querySelector(".key-7").addEventListener('click', Key7);
    function Key7(){
        var sound:HTMLAudioElement = new Audio('../assets/Keyboard/b.mp3');
        sound.play();
        sound.volume = 0.2;
    }  
